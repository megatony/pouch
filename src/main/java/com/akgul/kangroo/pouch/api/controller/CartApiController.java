...
import com.akgul.kangroo.pouch.api.model.*;
...
public class CartApiController {
    ...
    public @ResponseBody PouchApiResponse deleteProductFromCart(Authentication authentication, @PathVariable(value = "cartItemId") Long cartItemId, @PathVariable(value = "productId") Long productId) {
        Product product = productService.getProductById(productId);
        ...
        if (ObjectUtils.isEmpty(cartItem)) {
            return new NotFoundPouchApiResponse("Cart item " + cartItemId + " is not found.");
        }
